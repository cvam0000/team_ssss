...
//get the login value by the post method
          ...
          <form accept-charset="utf-8" method="POST" action="" class="simform">
            <div class="sminputs">
              <div class="input full">
                ...
                <input class="string optional" maxlength="255" name="user_email" placeholder="Email" type="email" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input string optional">
                <label class="string optional" for="user-pw">Password *</label>
                <input class="string optional" maxlength="255" name="passwd" placeholder="Password" type="text" size="50" />
              </div>
              <div class="input string optional">
